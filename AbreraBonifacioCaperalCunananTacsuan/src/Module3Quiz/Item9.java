...
public class Item9 extends Quiz {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 400, 217);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
		JLabel lblNewLabel = new JLabel("<html><body><p style='width: 300px;'>This consists of verifiable facts, the other of unverifiable ones, although many of them are often accepted as true because tradition has held them so far.</p></body></html>");
